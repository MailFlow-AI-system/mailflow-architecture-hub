...
- `@biomejs/biome` — MIT. See the package license distributed with the dependency.
- `@playwright/test` — Apache-2.0. See the package license distributed with the dependency.
